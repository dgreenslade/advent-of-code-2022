...
class Rope():
    ...
    """
    def __init__(self, head_pos=None, rope_len=2):
        self.head_pos = [0,0] if head_pos is None else head_pos
        self.tail_pos = []
    ...
    def __str__(self)->str:
        return f'Rope.. Head:{self.head_pos} Tail:{self.tail_pos}'
